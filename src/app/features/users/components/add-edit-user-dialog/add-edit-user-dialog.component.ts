...
import {
  IAddressFormGroup,
  IUserListAddEditFormModel,
} from '../../models/user-list-add-edit-form.model';
import { User } from '../../models/users.model';
import { Store } from '@ngrx/store';
import { getCurrentUser, getUserEditAdded, UsersState } from '../../store';
...
export class AddEditUserDialogComponent extends Destroyable implements OnInit {
  ...
  public currentUser$ = this.store
    ...
    .pipe(tap((currentUser) => this.selectCurrentUser(currentUser)));
  public userAddOrEdited$ = this.store.select(getUserEditAdded);
