...
export const updateCurrentUser = createAction(UsersActionsTypes.UPDATE_CURRENT_USER,
    props<{ user: User | null }>()
);

export const addUser = createAction(UsersActionsTypes.ADD_USER,
  props<{ user: User }>()
);

export const addUserSuccess = createAction(UsersActionsTypes.ADD_USER_SUCCESS,
  props<{ user: User }>()
);

export const addUserFail = createAction(UsersActionsTypes.ADD_USER_FAIL);

export const editUser = createAction(UsersActionsTypes.EDIT_USER,
  props<{ user: User }>()
);

export const editUserSuccess = createAction(UsersActionsTypes.EDIT_USER_SUCCESS,
  props<{ user: User }>()
);

export const editUserFail = createAction(UsersActionsTypes.EDIT_USER_FAIL);

export const deleteUser = createAction(UsersActionsTypes.DELETE_USER,
  props<{ user: User }>()
);

export const deleteUserSuccess = createAction(UsersActionsTypes.DELETE_USER_SUCCESS,
